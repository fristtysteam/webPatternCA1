...
public class UserDao extends Dao implements UserDaoInterface{
    ...
    public User registerUser(String username, String email, String password, String address, String phone) throws NoSuchAlgorithmException {
        ...
        try{
            String query = "INSERT INTO users(userName, email, password, address, phone, fees, salt, userType) VALUES (?, ?, ?, ?, ?, 0, ?, 0)";
            con = getConnection();
            ...
            if(rs.next())
            {
                ...
                newId = rs.getInt(1);
                user = new User(newId, username, email, password, address, phone, 0, null, 0);
            }
    ...
    public User loginUser(String email, String password) {
        ...
        try{
            ...
            if(rs.next())
            {
                ...
                user = new User(newId, username, email, pass, address, phone, fees, null, userType);
            }
...
//    private boolean checkPassword(String hashPassword, String salt){
//
//    }
}
